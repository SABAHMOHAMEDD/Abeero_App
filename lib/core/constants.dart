...
Color KSecondryColor = const Color(0xFFFFB30F).withOpacity(.6);
...
////////// Fav constants ///////////////
const String tableProductFav = 'favProduct';
const String columnNameFav = 'name';
const String columnImageFav = 'productImage';
const String columnPriceFav = 'price';
const String columnProductIdFav = 'productId';